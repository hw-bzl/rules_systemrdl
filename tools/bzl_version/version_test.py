...
class RepoVersionTests(unittest.TestCase):
    """Test that the `rules_systemrdl` versions match for WORKSPACE and bzlmod."""
    ...
    def test_versions(self) -> None:
        ...
        version_bzl = rlocation(runfiles, "rules_systemrdl/version.bzl")
        ...
        module_bazel = rlocation(runfiles, "rules_systemrdl/MODULE.bazel")
        module_version = re.findall(
            r'module\(\n\s+name = "rules_systemrdl",\n\s+version = "([\d\w\.]+)",\n',
